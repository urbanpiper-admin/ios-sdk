...
public class MixpanelObserver: AppAnalyticsEventObserver, SDKAnalyticsEventObserver {
    var mixpanelToken: String?
    var disposeBag: DisposeBag = DisposeBag()

    @discardableResult public init(mixpanelToken: String) {
    ...
    public func track(event: SDKAnalyticsEvent) {
        ...
        case let .purchaseCompleted(_, userWalletBalance, checkoutBuilder, isReorder):
            ...
            let dictionary: [String: MixpanelType] = ["payable_amt": checkoutBuilder.order?.payableAmount ?? Double.zero,
