...
public extension UrbanPiperSDK {
    ...
    @discardableResult public func refreshUserData(completion: (([String : Any]?) -> Void)?, failure: APIFailure?) -> URLSessionDataTask? {
        return UserManager.shared.refreshUserData(completion: completion, failure: failure)
    }
    
    @discardableResult public func updateUserInfo(name: String, phone: String, email: String, gender: String?, anniversary: Date?, birthday: Date?, completion: (([String : Any]?) -> Void)?, failure: APIFailure?) -> URLSessionDataTask {
    ...
    @discardableResult public func changePassword(phone: String, oldPassword: String, newPassword: String, completion: (([String : Any]?) -> Void)?, failure: APIFailure?) -> URLSessionDataTask? {
...
extension UrbanPiperSDK {
    ...
    @discardableResult public func login(username: String, password: String, completion: @escaping ((User?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
        return UserManager.shared.login(username: username, password: password, completion: completion, failure: failure)
    }
    
    @discardableResult public func socialLogin(email: String, socialLoginProvider: SocialLoginProvider, accessToken: String, completion: @escaping ((User?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
...
extension UrbanPiperSDK {
    ...
    @discardableResult public func registerUser(name: String, phone: String, email: String, password: String, referralObject: Referral?, completion: @escaping (CardAPIResponse?) -> Void, failure: @escaping APIFailure) -> URLSessionDataTask {
    ...
    @discardableResult public func registerSocialUser(name: String, phone: String, email: String, gender: String?, socialLoginProvider: SocialLoginProvider, accessToken: String, referralObject: Referral?, completion: @escaping ((CardAPIResponse?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
    ...
    @discardableResult public func verifyPhone(phone: String, email: String, socialLoginProvider: SocialLoginProvider, accessToken: String, completion: @escaping ((User?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
...
extension UrbanPiperSDK {
    ...
    @discardableResult public func verifyPhone(_ phone: String, otp: String, completion: @escaping ((CardAPIResponse?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
        return UserManager.shared.verifyPhone(phone, otp: otp, completion: completion, failure: failure)
    }
    
    @discardableResult public func verifySocialOTP(phone: String, email: String, socialLoginProvider: SocialLoginProvider, accessToken: String, otp: String, completion: @escaping ((User?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
    ...
    @discardableResult public func resendOTP(phone: String, completion: @escaping ((CardAPIResponse?) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
...
extension UrbanPiperSDK {
    ...
    @discardableResult public func forgotPassword(phone: String, completion: @escaping (Bool) -> Void, failure: @escaping APIFailure) -> URLSessionDataTask {
        return UserManager.shared.forgotPassword(phone: phone, completion: completion, failure: failure)
    }
    
    @discardableResult public func resetPassword(phone: String, otp: String, password: String, confirmPassword: String, completion: @escaping ((Bool) -> Void), failure: @escaping APIFailure) -> URLSessionDataTask {
