Pod::Spec.new do |s|
    ...
    s.resources = ['UrbanPiperSDK/Internal/WLDetailOptionData.plist']

    s.xcconfig = { 'SWIFT_INCLUDE_PATHS' => '"${PODS_TARGET_SRCROOT}/UrbanPiperSDK/GoogleAnalyticsSDK/"' }
    ...
    :script => 'cat <<EOF > "${PODS_TARGET_SRCROOT}/UrbanPiperSDK/GoogleAnalyticsSDK/module.modulemap"
